  ...
  _createClass(Tags, [{
    ...
    value: function handle() {
        ...
        _this5.getEntry(_this5.server, function (tags) {
          if (tags === null) {
            ...
            _this5.setEntry(_this5.server, entry, function (success) {
              if (success === true) {
                _this5.send(_this5.channel, [':white_check_mark:  Saved tag **' + tag + '** with text *' + text + '*', 'Use `>>' + tag + '` to access the saved text!']);
              }
            });
          } else {
            if (Object.keys(tags).indexOf(tag) > -1) {
              _this5.reply(['The tag **' + tag + '** already exists!', 'To edit a tag, enter __' + _this5.prefix + 'tags edit **<tag name>** > **<new text>**']);
            } else {
              tags[tag] = text;
      ...
      this.responds(/^tags edit (.+) > (.+)$/i, function (matches) {
        ...
        _this5.getEntry(_this5.server, function (tags) {
          if (tags === null) {
            _this5.reply(['The tag **' + tag + '** doesn\'t exist!', 'To create a new tag, enter __' + _this5.prefix + 'tags create **<tag name>** > **<text>**__']);
          } else {
            if (Object.keys(tags).indexOf(tag) === -1) {
              _this5.reply(['The tag **' + tag + '** doesn\'t exist!', 'To create a new tag, enter __' + _this5.prefix + 'tags create **<tag name>** > **<text>**__']);
            } else {
              ...
              _this5.setEntry(_this5.server, tags, function (success) {
                if (success === true) {
                  _this5.send(_this5.channel, [':white_check_mark:  Edited tag **' + tag + '** to text *' + text + '*', 'Use `>>' + tag + '` to access the new tag!']);
                }
              });
            }
          }
        ...
        _this5.getEntry(_this5.server, function (tags) {
          if (tags === null) {
            ...
            if (Object.keys(tags).indexOf(tag) === -1) {
              ...
              _this5.setEntry(_this5.server, tags, function (success) {
                if (success === true) {
                  _this5.send(_this5.channel, [':white_check_mark:  Deleted tag **' + tag + '**']);
                }
              });
            }
          }
