...
var Abyssal = function (_BaseCommand) {
  ...
  _createClass(Abyssal, [{
    ...
    key: 'gelbooru',
    value: function gelbooru(name, query) {
      var _this3 = this;
    ...
    key: 'yandere',
    value: function yandere(name, query) {
      var _this4 = this;
    ...
    value: function handle() {
      ...
      this.responds(/^abyssal$/i, function () {
        var data = _WaifuDB2.default.Abyssals;
...
//# sourceMappingURL=abyssal.js.map
