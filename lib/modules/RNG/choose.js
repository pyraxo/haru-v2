...
var Choose = function (_BaseCommand) {
  ...
  _createClass(Choose, [{
    ...
    key: 'usage',
    get: function get() {
      return ['The **choose** command will allow the bot to choose among your given options', ['**choose** <choice 1>, <choice 2>[, choices...]'], 'e.g. `choose black and blue, white and gold, neither`', 'Reply: _I pick **white and gold**!_'];
    }
  }]);
