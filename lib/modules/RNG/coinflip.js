...
var Coinflip = function (_BaseCommand) {
  ...
  _createClass(Coinflip, [{
    ...
    key: 'usage',
    get: function get() {
      return ['The **coinflip** command tosses coins and gives you the results.', ['**this.prefix coinflip [number of coins]**' + ' where the no. of coins flipped defaults to 1'], 'e.g. `coinflip 20`', 'Aliases: `cointoss, coins`'];
    }
  }]);
