    ...
    value: function handle() {
      ...
      this.responds(/^request (.+)$/i, function (matches) {
        _this2.client.admins.forEach(function (id) {
          ...
          if (admin) {
            _this2.send(admin, ['**' + _this2.sender.name + '** requested a new feature:\n', matches[1]].join('\n'));
          }
        });
        _this2.reply('Thank you for your input! ' + 'The admins will be looking into your request shortly.');
      });
    }
  }], [{
    key: 'name',
